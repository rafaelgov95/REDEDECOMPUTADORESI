...
//        }
//
//        TreeItem<String> rootNode=new TreeItem<>(hostName,new ImageView(new Image(ClassLoader.getSystemResourceAsStream("utilfull/computer.png"))));
//
//
//
//        Iterable<FTPFile> rootDirectories=  ;
//
//        for(FTPFile name:rootDirectories){
//
