...
//    public static Image folderCollapseImage=new Image(getClass.("utilfull/folder.png"));
//    public static Image folderExpandImage=new Image(ClassLoader.getSystemResourceAsStream("utilfull/folder-open.png"));
//    public static Image fileImage=new Image(ClassLoader.getSystemResourceAsStream("utilfull/text-x-generic.png"));
//
